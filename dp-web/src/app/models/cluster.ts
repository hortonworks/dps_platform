...
export class ClusterDetails {
 ...
 kafkaBrokerTopicsIn: string;
 kafkaBrokerTopicsOut: string;
 kafkaBrokerMessagesIn: string;
 activeControllerCount: string;
 replicaMaxLag: string;
 underReplicatedPartitions: string;
 replicationMgrLeaderCount: string;
 averageKafkaPartitionCount: string;
 healthyKafkaBrokersCount: number;
 unhealthyKafkaBrokersCount: number;
}
