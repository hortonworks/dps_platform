...
class LdapConfigRepo @Inject()(
  ...
  final class LdapConfigTable(tag: Tag) extends Table[LdapConfiguration](tag, Some("dataplane"), "ldap_configs") {
    ...
    def * = (id, ldapUrl, bindDn, userSearchBase, userSearchAttributeName, userObjectClass, groupSearchBase, groupSearchAttributeName, groupObjectClass, groupMemberAttributeName) <> ((LdapConfiguration.apply _).tupled, LdapConfiguration.unapply)
